    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="{{asset('assets')}}/frontend/images/logo.png" alt="img" class="fh5co_logo_width"/>
            </div>
...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
    <div class="container padding_786">
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <a class="navbar-brand" href="#"><img src="{{asset('assets')}}/images/logo.png" alt="img" class="mobile_logo_width"/></a>
