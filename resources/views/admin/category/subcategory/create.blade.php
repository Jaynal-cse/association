...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Create Sub-category</a> </div>
  <h1> Add Sub-Category</h1>
</div>
<div class="container-fluid">
  <hr>
  <form action="{{ route('admin.sub-category.store') }}" method="POST" class="form-horizontal" method="POST" enctype="multipart/form-data">
    @csrf
	  ...
	  <div class="widget-box">
        ...
        <div class="widget-content nopadding">
			 ...
			 <div class="form-actions">
              <button type="submit" class="btn btn-success" style=" width:100%;border-radius:5px">Add Sub-Category</button>
