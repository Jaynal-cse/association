...
class CategoryController extends Controller
{
	...
	public function indexCcategory($category_id)
    {
        $subcategories = Subcategory::where('category_id',$category_id)->orderBy('category_id','asc')->get();
